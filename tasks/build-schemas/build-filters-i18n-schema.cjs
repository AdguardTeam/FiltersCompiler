...
import { createSchemaTitle, createStringPropertySchema } from './helpers.js';
import { GROUPS_DEFAULT_DATA, FILTERS_DEFAULT_DATA, TAGS_DEFAULT_DATA } from './filters-i18n-defaults.js';
